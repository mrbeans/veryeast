...
class VeryEast(object):
    Headers={
        ...
        "Cookie":r"UM_distinctid=162b01261a41e2-066d614761ae76-b34356b-1fa400-162b01261a52d4; _ga=GA1.2.506522556.1523372423; ps_resume_favoritelist=10; ps_ibackground_index_list=10; ps_search_index=10; _gid=GA1.2.1068639901.1526571278; Hm_lvt_bb6401d33941b99b0b91e2622ae7596d=1524987293,1525012619,1525599480,1526571278; Hm_lpvt_bb6401d33941b99b0b91e2622ae7596d=1526571278; ticket=0330fjXDgyCpDIghsTAdBPF1fLCC8OqCvyMcUVzeI1LZBhFvy4O7CLXL1XjFLEmbgyrnG9FjKwETheIc%2BrZY; username=waterman; user_type=1; current_app=a%3A1%3A%7Bi%3A1%3Bi%3A1%3B%7D; _expire=1527176150; closePop=true; _gat=1; _bl_uid=z0j54hwCambpzC6dd6atlI4392bI; uid=very_2840997; sdktoken=8681f18f929279ea2ce59fb324c30e06; nickName=18621538364@%u5468%u53E3%u65C5%u5982%u5BB6%u9152%u5E97; avatar=",
        ...
        try:
            for data in cursor:
                ...
                for main in preview_main_list:
                    ...
                    if(title=='最近一份工作'):
                        preview['lastest_work']=getinfo_lastest_work(main)
                    elif(title=='求职意向'):
                        preview['job_intension']=getinfo_intension(main)
                    elif(title=='工作经验'):
                        preview['work_experiences']=getinfo_experience(main)
                    elif(title=='语言能力'):
                        preview['language_info']=getinfo_language(main)
                    elif(title=='技能与特长'):
                        preview['special_skills']=getinfo_special(main)
                    elif(title=='教育经历'):
                        preview['education_experience']=getinfo_education(main)
                    elif(title=='培训经历'):
                        preview['train_experience']=train_experience(main)
                    elif(title=='证书'):
                        preview['certificates']=getinfo_certificate(main)
                    elif(title=='其他'):
                        preview['other']=getinfo_other(main)
                    elif(title=='附件'):
                        preview['enclosures']=getinfo_attachment(main)
                print(preview)
        finally:
            cursor.close()

    def getinfo_lastest_work(self,element):
        lastest_work={}
    ...
    def getinfo_intension(self,element):
        job_intension={}
    ...
    def getinfo_experience(self,element):
        work_experiences=[]
    ...
    def getinfo_language(self,element):
        language_info={}
    ...
    def getinfo_special(self,element):
        special_skills=[]
    ...
    def getinfo_education(self,element):
    ...
    def getinfo_train(self,element):
        train_experience=[]
        ...
        return train_experience

    def getinfo_certificate(self,element):
        certificates=[]
        certificate=element.xpath('ul')
    ...
    def getinfo_other(self,element):
        other=[]
        other_ul=element.xpath('ul')
        if(len(other_ul)<=0):
            continue
    ...
    def getinfo_attachment(self,element):
        enclosures=[]
        image_list=element.xpath('ul/li/a')
        if(len(image_list)<=0):
            continue
